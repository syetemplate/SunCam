...
export default {
    ...
    hero: {
        ...
        description: 'שמרו על הבית בביטחון ובאופן ידידותי לסביבה! מצלמת האבטחה הסולארית שלנו מציעה פתרון קל לתפעול, ללא צורך בסוללות או חשמל. המצלמה מופעלת על ידי השמש באופן סולארי ומבטיחה הגנה רציפה על הנכס שלכם, יומם ולילה.',
        imageName: 'hero.png',
        cta: {
            text: 'רכישה',
            href: '/products',
    ...
    features: {
        list: [
            ...
            },
            {
                ...
                description: 'שתי מצלמות אשר מספקות צפייה וזווית רחבה לצד מעקב PTZ מפורט, שתיהן באיכות תמונה HD‏ 4K (8MP).',
                imageName: 'feature-2.png',
            },
            {
                title: 'מעקב חכם אחר תנועת אדם',
                description: 'המצלמה מסתובבת ועוקבת אחר תנועת, כך שתוכלו לראות הכל.',
                imageName: 'feature-3.png',
            },
            {
                title: 'ראייה לילה צבעונית מלאה',
                description: 'מצב ראיית לילה מלאה עם פנסים מובנים המספקת תמונות ברורות גם בתנאי תאורה חלשה.',
    ...
    benefits: {
        ...
        subtitle: 'SunCam היא המצלמה הטובה ביותר לאבטחת הבית או העסק שלכם. הנה כמה יתרונות של השימוש במצלמת אבטחה סולארית.',
        imageName: 'benefits.webp',
        list: [
            {
                title: 'שדה ראייה של 360 מעלות',
                description: 'כיסוי מלא של 360 מעלות',
                imageName: 'benefit-1.png',
            },
            {
                title: 'פעולה באמצעות אנרגיה סולארית',
                description: 'חסכון בעלויות חשמל וידידותית לסביבה.',
                imageName: 'benefit-2.png',
            },
            {
                title: 'גישה מרחוק',
                description: 'צפייה בלייב ובהקלטות מכל מקום באמצעות הפלאפון או המחשב.',
                imageName: 'benefit-3.png',
            },
            {
                title: 'WiFi/4G',
                description: 'חיבור יציב לאינטרנט, משדר באופן רציף.',
                imageName: 'benefit-4.png',
            },
            {
                title: 'התקנה קלה',
                description: 'ללא צורך בהתקנה מסובכת, פשוט להתקין ולהפעיל.',
    ...
    footer: {
        text: 'SunCam מציעה מצלמת אבטחה סולארית מתקדמת, קלה להתקנה ויעילה במיוחד עבור בתים ועסקים.',
        social: [
    ...
    blog: {
        title: 'טיפים לאבטחה',
        description: 'מביאה לכם מידע שימושי,טיפים וסקירות מוצרים כדי לעזור לכם לבחור את מצלמת האבטחה הסולארית הטובה ביותר עבורכם ולהישאר מעודכנים.',
        posts: [
            {
                date: '9 מרץ, 2024',
            ...
            },
            {
                ...
                content: [
                    ...
                    {
                        type: 'blockquote',
                        text: 'איכות הראייה הלילית היא גורם קריטי במצלמות אבטחה. חפשו מצלמות עם LED אינפרא-אדום חזק או טכנולוגיית ראיית לילה צבעונית לתוצאות הכי טובות.'
                    },
                    {
                        type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    ...
                    {
                        type: 'paragraph',
                        text: '4. הגנה מפני מזג אוויר: למרות שרוב המצלמות הסולאריות מיועדות לשימוש חיצוני, כדאי לשקול להוסיף הגנה נוספת כמו גגון קטן מעל המצלמה להגנה מפני גשם כבד .'
                    },
                    {
                        type: 'paragraph',
    ...
    privacyPolicy: {
        ...
        sections: [
            ...
            {
                title: 'הבחירות שלך',
                content: 'יש לך בחירות לגבי המידע שלך, כולל אופן השימוש והשיתוף בו. אתה יכול לעדכן את פרטי החשבון שלך והעדפות התקשורת, ושיש לך את הזכות לגשת, לתקן או למחוק את המידע האישי שלך.',
            },
            {
                title: 'צורו קשר',
                content: 'אם יש לך שאלות כלשהן לגבי מדיניות פרטיות זו, אנא צור איתנו קשר בכתובת suncam@gmail.co.il',
            },
        ],
    },
    termsAndConditions: {
        ...
        sections: [
            ...
            {
                title: 'שינוי התנאים',
                content: 'SunCam רשאית לשנות תנאים אלה בכל עת כפי שהיא רואה לנכון, ועל אחריותך להתעדכן במידה וישונו התנאים.',
            },
            {
                title: 'הסבה',
    ...
    aboutUs: {
        ...
        sections: [
            ...
            {
                title: 'היתרון שלנו',
                content: 'ב-SunCam, אנחנו מבינים שאבטחה היא לא רק עניין של טכנולוגיה, אלא גם של אמון. אנחנו מתגאים ביחס האישי ללקוחות שלנו, בתמיכה הטכנית המעולה ובמחויבות שלנו לאיכות ללא פשרות. המוצר שלנו לא רק מספקים אבטחה מתקדמת, אלא גם חוסכת בעלויות חשמל ע״י אנרגיה סולארית.'
            },
            {
                title: 'העתיד של אבטחה ירוקה',
                content: 'אנחנו לא רק חולמים על עתיד שבו כל בית ועסק יכולים ליהנות מאבטחה מתקדמת וידידותית לסביבה  . עם SunCam, אתם לא רק מגנים על הנכס שלכם, אלא גם תורמים לעתיד ירוק יותר. הצטרפו אלינו למסע לעבר אבטחה חכמה, יעילה וירוקה!'
            }
        ]
    },
    products: {
        ...
        items: [
            {
                ...
                productInfo: {
                    title: 'פרטי המוצר',
                    list: [
                        { title: 'ראיית לילה', description: 'עד 40 מטר' },
                        { title: 'חיישן תנועה', description: '4MP+4MP - מצלמה עם חיישן כפול' },
                        { title: 'סוללה', description: '4 סוללות נטענות (סך הכל 20000mAh).' },
                        { title: 'אחסון', description: 'כרטיס SD 32GB' },
                        { title: 'חיישן', description: 'אינפרא אדום פסיבי' },
                        { title: 'חיבור לענן', description: 'חיבור לענן באמצעות אינטרנט אלחוטי' },
                        { title: 'פאנל סולארי', description: 'פאנל סולארי מובנה 5 ואט לייצור חשמל בכל מקום' },
                        { title: '2 מצלמות', description: 'מצלמת זום ומצלמת רחבה' },
                ...
                description: {
                    title: '',
                    text: 'SunCam  היא הבחירה המושלמת למי שמחפש פתרון אבטחה אמין וידידותי לסביבה. עם מצלמה באיכות HD, חיישן תנועה חכם וסוללה נטענת סולארית, היא מספקת אבטחה 24/7 ללא צורך בחיבור לחשמל.'
                },
                additionalInfo: {
                    title: 'מידע נוסף',
                    text: '<strong>SunCam 32GB כולל</strong>:<br>1 x מצלמת אבטחה סולארית SunCam<br>1 x פאנל סולארי<br>4 x סוללה נטענת<br>1 x מדריך למשתמש'
                },
                reviews: {
                    title: 'ביקורות',
                    list: [
            ...
            },
            {
                ...
                description: {
                    title: '',
                    text: 'SunCam  מציעה אבטחה ברמה גבוהה עם תכונות מתקדמות. עם רזולוציה של 2K, זיהוי תנועה מבוסס AI וראיית לילה צבעונית, היא מספקת תמונה ברורה וחדה בכל תנאי תאורה. הסוללה המשופרת והפאנל הסולארי היעיל מבטיחים פעולה רציפה לאורך זמן.'
                },
                additionalInfo: {
                    title: 'מידע נוסף',
                    text: '<strong>SunCam 64GB כולל</strong>:<br>1 x מצלמת אבטחה סולארית SunCam<br>1 x פאנל סולארי<br>4 x סוללה נטענת<br>1 x מדריך למשתמש'
                },
                reviews: {
                    title: 'ביקורות',
                    list: [
            ...
            },
            {
                ...
                description: {
                    title: '',
                    text: 'SunCam  היא פסגת הטכנולוגיה בתחום מצלמות האבטחה הסולאריות. עם רזולוציית 4K, זום אופטי x4 ומערכת AI מתקדמת, היא מספקת את רמת האבטחה הגבוהה ביותר. הסוללה רבת העוצמה והפאנל הסולארי המתקדם מבטיחים פעולה ממושכת גם בתנאי מזג אוויר קשים.'
                },
                additionalInfo: {
                    title: 'מידע נוסף',
                    text: '<strong>SunCam 128GB כולל</strong>:<br>1 x מצלמת אבטחה סולארית SunCam<br>1 x פאנל סולארי<br>4 x סוללה נטענת<br>1 x מדריך למשתמש'
                },
                reviews: {
                    title: 'ביקורות',
                    list: [
    ...
    faq: {
        ...
        list: [
            ...
            {
                question: 'איך פועל הפאנל הסולארי המובנה?',
                answer: 'הפאנל הסולארי המובנה מייצר חשמל בעוצמה של 5 ואט, כך שתוכלו להתקין את המצלמה בכל מקום ללא צורך בחיבור לחשמל.',              
            },
            {
                question: 'האם SunCam קלה להתקנה?',
                answer: 'כן, SunCam תוכננה להיות קלה להתקנה. היא מגיעה עם ערכת התקנה מלאה ומדריך מפורט. המאפשר יכולת הטענה בזמן קצר.',
            },
            {
                question: 'האם ניתן לצפות בצילומים בזמן אמת מכל מקום?',
                answer: 'כן, SunCam מתחברת לענן באמצעות אינטרנט אלחוטי, מה שמאפשר צפייה ישירה בצילומים מכל מקום בעולם דרך האפליקציה.',
            },
            {
                question: 'האם SunCam עמידה בתנאי מזג אוויר ?',
                answer: 'כן,  SunCam מיוצרת מחומרים עמידים ומתוכננת לעמוד בתנאי מזג האוויר, .',
            },
        ],
    },
    facts: {
        title: 'אנחנו כבר <span className="color-primary">5 שנים בתחום</span>',
        description: 'SunCam מתמחה בייצור מצלמת אבטחה סולאריות איכותית, קלה להתקנה ויעילה במיוחד עבור בתים ועסקים. עם ניסיון של 5 שנים, אנו מחויבים לספק פתרונות אבטחה מתקדמים ללקוחותינו.',
        items: [
            {
                icon: 'local_shipping',
                value: 5000,
